...
{
       0,    38,    38,    39,    42,    42,    42,    42,    42,    42,
      42,    42,    42,    42,    42,    42,    46,    46,    46,    46,
      46,    46,    49,    51,    53,    55,    57,    59,    64,    67,
...
{
  "$end", "error", "$undefined", "WORD", "DOTDOT", "LESSTHAN",
  "GREATERTHAN", "PIPE", "DOUBLEQUOTES", "BACKSLASH", "AMPERSAND",
  "SETENV", "PRINTENV", "UNSENTENV", "HOME", "HOME_PATH", "CD", "UNALIAS",
  "ALIAS", "BYE", "$accept", "inputs", "input", "C_META", "C_LESSTHAN",
  "C_GREATERTHAN", "C_PIPE", "C_DOUBLEQUOTES", "C_BACKSLASH",
  "C_AMPERSAND", "C_CD", "C_DOTDOT", "C_WORD", "C_SETENV", "C_PRINTENV",
  "C_UNSENTENV", "C_HOME", "C_HOME_PATH", "C_UNALIAS", "C_ALIAS", "C_BYE", YY_NULLPTR
};
#endif
...
{
       2,     0,     1,    30,    29,    22,    23,    24,    25,    26,
      27,    31,    32,    33,    34,    35,    28,    36,    37,    38,
       3,     4,    16,    17,    18,    19,    20,    21,     5,     6,
