...
{
  "$end", "error", "$undefined", "DOTDOT", "LESSTHAN", "GREATERTHAN",
  "PIPE", "DOUBLEQUOTES", "BACKSLASH", "AMPERSAND", "SETENV", "PRINTENV",
  "UNSETENV", "HOME", "HOME_PATH", "CD", "UNALIAS", "ALIAS", "BYE", "WORD",
  "NUMBER", "$accept", "inputs", "input", "C_META", "C_LESSTHAN",
  "C_GREATERTHAN", "C_PIPE", "C_DOUBLEQUOTES", "C_BACKSLASH",
  "C_AMPERSAND", "C_CD", "C_DOTDOT", "C_WORD", "C_SETENV", "C_PRINTENV",
  "C_UNSETENV", "C_HOME", "C_HOME_PATH", "C_UNALIAS", "C_ALIAS", "C_BYE", YY_NULLPTR
};
#endif
...
{
       2,     0,     1,    29,    22,    23,    24,    25,    26,    27,
       0,     0,     0,    34,    35,    28,    36,    37,    38,    30,
